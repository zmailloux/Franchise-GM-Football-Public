...
This isn't a once-a-year gate. Before **any** week your club is scheduled to play, four things must be true at once: your active roster at or under **53**, at or above the **44** floor, your practice squad at or under **16**, and your cap spending at or under the limit. A fifth blocks you too — a position your scheme requires with **no healthy body left** to field it. Fail any of them and the week won't advance until you fix it: cut, restructure, sign somebody, or move a player between the roster and the squad. (Being merely *thin* at a position is a warning, not a block; being at zero is a block.) During the offseason you may carry more than 53 freely. Cutting and the dead money it leaves live in [Contracts](#contracts).
:::
...
**And when you disagree with the machine, you can pin.** Your **defensive** scheme roles normally fill themselves, but you can long-press a defender's chip on the LINEUP tab and **pin him to a role** — the game honors it even when he's a worse fit and sorts the rest around him. Unpin and the automatic assignment takes back over. There is no equivalent on offense. More on what a role slot is: [Schemes & Scheme Fit](#schemes--scheme-fit-how-well-your-roster-matches).

**The roster screen also shows what your scheme actually requires.** Each position group carries a required-starters count derived from the looks your [scheme](#schemes) really plays, and if injuries leave a group short of its slots you're warned before kickoff — a nudge to promote, sign, or slide a body over before a backup's backup does it for you. Short is a warning; **zero healthy bodies** at a position your scheme requires is a hard block, and the week won't advance until you find one.
